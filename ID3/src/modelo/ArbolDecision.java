...
public class ArbolDecision {
	 ArrayList<ArrayList<String>> matrizDatos = new ArrayList<>();
	    ...
	    public void runArbolDecision() {
	        ...
	        Auxiliar salida = correrAlgoritmo(matrizDatos, cantClases, new ArrayList<>(nombreAtributos), tiposClases);    
	        proceso = "Ejecucion del algoritmo: \n\n" + salida.getProceso();
	    ...
	    private Auxiliar getEntropiaVariables(int columna, ArrayList<ArrayList<String>> matrizAux, ArrayList<String> tiposClases, String nombreAtributo, ArrayList<String> variablesAtributo) {
	        Auxiliar salida = new Auxiliar();
	    ...
	    private Auxiliar getEntropiaAtributo(ArrayList<Double> entropiaVariables, ArrayList<ArrayList<String>> matrizAux, int columna, String atributo) {
	        Auxiliar salida = new Auxiliar();
	        double total = matrizAux.size();
	        double entropia = 0;
	        ...
	        stringAux = "Merito "+atributo+": "+stringAux.substring(1)+"= "+entropia+"\n\n";
	    ...
	    private Auxiliar correrAlgoritmo(ArrayList<ArrayList<String>> matrizAux, int cantClases, ArrayList<String> atributos, ArrayList<String> tiposClases) {
	        Auxiliar salida = new Auxiliar();
	        ...
	        for (int i = 0; i < matrizAux.get(0).size()-1; i++) {
	            ...
	            Auxiliar datosEntropiaVariable = getEntropiaVariables(i, matrizAux, tiposClases, atributos.get(i), variablesAtributo);
	            ...
	            Auxiliar datosEntropiaAtributo = getEntropiaAtributo(datosEntropiaVariable.getValores(), matrizAux, i, atributos.get(i));
	        ...
	        proceso += "Atributo seleccionado (menor merito): " + atributos.get(indexMejorAtributo)+"\n";
	        ...
	        for (int i = 0; i < subMatriz.size(); i++) {
	            ...
	            Auxiliar salidaAux = correrAlgoritmo(subMatriz.get(i), cantClases, subAtributos, tiposClases);
